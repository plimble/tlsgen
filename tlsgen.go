...
// 	log.Println("Private root certificate created: ", "ca.pem")
// 	log.Println("Web server certificate created: ", "cert.pem")
// 	log.Println("Web server key created: ", "key.pem")
// }
...
// 	_, err = callCommand("openssl", "req", "-x509", "-new", "-key", "myCA.key", "-out", "ca.pem", "-days", "730", "-subj", "/CN=\""+certificateAuthorityName+"\"")
// 	if err != nil {
...
// 	_, err := callCommand("openssl", "genrsa", "-out", "key.pem", "2048")
// 	if err != nil {
// 		log.Fatal("Could not create private server key")
// 	}

// 	_, err = callCommand("openssl", "req", "-new", "-out", "cert.pem", "-key", "key.pem", "-subj", "/CN="+host)
// 	if err != nil {
// 		log.Fatal("Could not create private server certificate signing request")
// 	}

// 	_, err = callCommand("openssl", "x509", "-req", "-in", "cert.pem", "-out", "cert.pem", "-CAkey", "myCA.key", "-CA", "ca.pem", "-days", "365", "-CAcreateserial", "-CAserial", "serial")
// 	if err != nil {
